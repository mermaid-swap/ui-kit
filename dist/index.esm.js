...
var Icon$q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 40 60" }, props),
        React.createElement("image", { width: "40", height: "60", href: "/images/egg/logo.png" })));
};
...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React.createElement(InactiveButton, __assign({ forwardedAs: as, size: size, variant: "tertiary", colorKey: variant === variants.PRIMARY ? "primary" : "primary" }, props)));
    }
...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 170 60" }, props),
        React.createElement("image", { width: "50", height: "60", href: "/images/egg/logobig.png" })));
};
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container$4, null,
        ...
        React.createElement(SettingsEntry, null,
            ...
            React.createElement(Dropdown, { position: "top-right", target: React.createElement(Button, { variant: "text", style: { padding: "2px" }, startIcon: React.createElement(LanguageIcon, { color: "textSubtle", width: "20px" }) },
                    React.createElement(Text, { style: { fontSize: "18px" }, color: "textSubtle" }, currentLang === null || currentLang === void 0 ? void 0 : currentLang.toUpperCase())) }, langs.map(function (lang) { return (React.createElement(MenuButton, { key: lang.code, fullWidth: true, onClick: function () { return setLang(lang); }, 
                // Safari fix
